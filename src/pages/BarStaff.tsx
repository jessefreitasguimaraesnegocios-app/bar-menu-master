...
import { Clock, ChefHat, CheckCircle2, Package, RefreshCw } from 'lucide-react';
...
const BarStaff = () => {
  ...
  const filteredOrders = orders.filter(order => order.kitchen_status === activeTab);
    ...
    <>
      ...
      <main className="min-h-screen bg-background p-4 md:p-6">
        <div className="max-w-7xl mx-auto">
          ...
          {/* Status Tabs */}
          <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as KitchenStatus)} className="space-y-6">
            ...
            <AnimatePresence mode="popLayout">
              {loading ? (
                ...
                >
                  ...
                  <p className="text-lg">Nenhum pedido {statusConfig[activeTab].label.toLowerCase()}</p>
                </motion.div>
              ) : (
                <motion.div
                  layout
                            ...
                            <div className="flex gap-2">
                              ...
                              {order.kitchen_status === 'ready' && (
                                <Button
                                  variant="outline"
                                  className="flex-1"
                                  onClick={() => updateKitchenStatus(order.id, 'pending')}
                                >
